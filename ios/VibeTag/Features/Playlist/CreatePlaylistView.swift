...
struct CreatePlaylistView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            if viewModel.prompt.isEmpty { viewModel.prompt = prompt }
    ...
    private var exportActionsView: some View {
        VStack(spacing: 12) {
            if viewModel.isExported {
                ExportSuccessBanner(onDone: { dismiss() })
                ...
                PrimaryActionButton(
                    ...
                    Task { await viewModel.exportPlaylist() }
                }
    ...
    private var headerLabel: some View {
        HStack(spacing: 6) {
            ...
            Text("Análisis de IA completo").font(.nunito(.caption, weight: .medium))
        }
